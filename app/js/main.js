...
/***/ function(module, exports, __webpack_require__) {
	...
	var _MessageList = __webpack_require__(207);
	...
	var _UserForm = __webpack_require__(212);
	...
	var App = function (_Component) {
		...
		_createClass(App, [{
			...
			value: function componentWillMount() {
				...
				this.socket = (0, _socket2.default)('http://localhost:8081');
			...
			value: function render() {
				...
				if (this.state.user == '') {
					...
					return _react2.default.createElement(_UserForm2.default, { emit: this.emit.bind(this), setUser: this.setUser.bind(this) });
				} else {
					...
					return _react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(_MessageForm2.default, _extends({}, this.state, { emit: this.emit.bind(this) }))
						)
					);
				}
			}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactEmoji = __webpack_require__(209);
		...
		_createClass(Message, [{
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					formattedTime,
					' - ',
					_reactEmoji2.default.emojify(message.text)
				);
			}
		}, {
			key: 'formatTime',
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement('input', { type: 'text', className: 'form-control', ref: 'text', placeholder: 'Type a message' })
					)
				);
			}
		}, {
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'form',
						{ onSubmit: this.onSubmit.bind(this) },
						_react2.default.createElement('input', { type: 'text', className: 'form-control', ref: 'name', placeholder: 'What\'s your name?' })
					)
				);
			}
		}, {
